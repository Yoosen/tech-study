...
find / -name “test”
```
![[attachments/Pasted image 20230428185631.png]]
...
![[attachments/Pasted image 20230428190138.png]]

- 查找所有以test结尾的文件：`find / -name “*test”`
![[attachments/Pasted image 20230428190130.png]]

- 查找所有包含test的文件：`find / -name “\*test\*”
![[attachments/Pasted image 20230428190147.png]]
...
### case
- 不带选项，统计文件
![[attachments/Pasted image 20230428192129.png]]
- 统计字节数
![[attachments/Pasted image 20230428192329.png]]
- 统计字符数
![[attachments/Pasted image 20230428192335.png]]
- 统计行数
![[attachments/Pasted image 20230428192343.png]]
- 统计单词数
![[attachments/Pasted image 20230428192351.png]]
...
![[attachments/Pasted image 20230428192719.png]]

- echo “Hello itheima” > itheima.txt，再次执行，覆盖新内容
![[attachments/Pasted image 20230428192741.png]]

- echo “Hello itcast” >> itheima.txt，再次执行，使用>>追加新内容
![[attachments/Pasted image 20230428192747.png]]
