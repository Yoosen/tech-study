...
<font color="#00b0f0">一个消息链表，将所有加入的消息都串起来，每个消息都有一个唯一的ID和对应的内容</font>
...
<font color="#ff0000">基本命令代码实操</font>
...
<font color="#ff0000">小总结（类似Java里面的阻塞队列）</font>
...
查询每个消费组内所有消费组<font color="#ff0000">[已读取、但尚未确认]</font>的消息
